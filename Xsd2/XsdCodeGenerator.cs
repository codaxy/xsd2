    ...
    public class XsdCodeGenerator
    {
        ...
        public void Generate(IList<String> schemas, TextWriter output)
        {
            ...
            if (Options.WriteFileHeader)
            {
                ...
                output.WriteLine("//     This code has been generated by a tool.");
                output.WriteLine("// </auto-generated>");
                output.WriteLine("//------------------------------------------------------------------------------");
                output.WriteLine();
            }
        ...
        private void ImproveCodeDom(CodeNamespace codeNamespace, XmlSchema schema)
        {
            ...
            foreach (CodeTypeDeclaration codeType in codeNamespace.Types)
            {
                ...
                if (Options.EnableDataBinding && codeType.IsClass)
                {
                    ...
                    codeType.BaseTypes.Add("System.ComponentModel.INotifyPropertyChanged");

                    codeType.Members.Add(new CodeMemberEvent()
                    {
                        Name = "PropertyChanged",
                        ImplementationTypes = {"System.ComponentModel.INotifyPropertyChanged"},
                    ...
                    codeType.Members.Add(new CodeMemberMethod()
                    {
                        ...
                        Statements =
                        {
                            new CodeVariableDeclarationStatement("System.ComponentModel.PropertyChangedEventHandler", "propertyChanged",
                                new CodeSnippetExpression("this.PropertyChanged")),
                            new CodeConditionStatement(new CodeSnippetExpression("(propertyChanged != null)"),
                                new CodeExpressionStatement(new CodeDelegateInvokeExpression(new CodeSnippetExpression("propertyChanged"),
                                    new CodeThisReferenceExpression(),
                                    new CodeSnippetExpression("new System.ComponentModel.PropertyChangedEventArgs(propertyName)"))))
                        }
                    });
                }
                                        ...
                                        new CodeConditionStatement(new CodeSnippetExpression("value != null"),
                                            new[]
                                            {
                                                ...
                                                new CodeAssignStatement(new CodeVariableReferenceExpression(fieldName),
                                                    new CodeSnippetExpression("value.Value")),
                                            },
                                            new[]
                                            {
